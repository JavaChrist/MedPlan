...
export const PillIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
  ...
  >
    <path d="M19.5 8.25l-7.5 7.5-7.5-7.5A6 6 0 0 1 12 1.5a6 6 0 0 1 7.5 6.75z" />
    <path d="M12 9L4.5 16.5a6 6 0 0 0 15 0L12 9z" fillOpacity="0.7" />
  </svg>
);
...
export const DoorIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M19 19V5c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v14H3v2h18v-2h-2zM13 11h-2v2h2v-2z" />
  </svg>
);
...
export const BrainIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M21.33 12.91c.09-.66.15-1.33.15-2.01 0-5.52-4.48-10-10-10s-10 4.48-10 10c0 .68.06 1.35.15 2.01C.75 14.09.12 15.98.12 18.06c0 1.66.63 3.17 1.66 4.32.68.75 1.56 1.22 2.53 1.39.31.06.63.09.95.09 1.17 0 2.31-.35 3.29-1 .23-.15.44-.32.63-.51.19.19.4.36.63.51.98.65 2.12 1 3.29 1 .32 0 .64-.03.95-.09.97-.17 1.85-.64 2.53-1.39 1.03-1.15 1.66-2.66 1.66-4.32 0-2.08-.63-3.97-1.71-5.15z" />
  </svg>
);
